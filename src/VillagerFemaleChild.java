public class VillagerFemaleChild extends Enemy
{
    
    public VillagerFemaleChild(int location, boolean facingRight)
    {
        //48, 48
        super("villagerFemaleChild", 1, 4, 0, 0, facingRight, location, 192, 192);
        initMove(6,90);
        setAction('m');
    }
